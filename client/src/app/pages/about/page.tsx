  ...
  return (
    <div className="bg-black">
      ...
      <div className="flex flex-col w-full h-[100vh] justify-center items-center px-20">
        ...
        <p className="text-white z-1 font-cormorant text-lf xl:text-5xl text-center">
        ...
        <p className=" text-lg xl:text-5xl mt-4 z-1 text-white font-cormorant text-center">
